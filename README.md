...
~~~sh
# getting the code
git clone git@github.com:nko4/theteam.git && cd ./theteam/

# developing
npm install
npm start

# deploying (to http://theteam.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@theteam.2013.nodeknockout.com
ssh root@theteam.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@theteam.2013.nodeknockout.com
ssh -i ./id_deploy root@theteam.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/theteam" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
